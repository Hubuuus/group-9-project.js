...
function movieCard(movie, genresName) {
  ...
  gallery.insertAdjacentHTML(
    ...
    ` <div class="MovieCard" id="${movie.id}">
        <img class ="MoviePoster" src="${poster}" onerror="this.src='https://ik.imagekit.io/paulinas/noTMDBposter.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1676735394520'" alt="${movie.title}" loading="lazy" /> 
